...
/**
 * Represents a medication that a patient receives. Recorded inside a Record object.
 */
public class Medication {
    public static final String MESSAGE_CONSTRAINTS = "Medication should be alphanumeric";
